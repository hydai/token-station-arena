...
pub fn render_article(title: &str, runs: &[RunResult]) -> String {
    ...
    [
        ...
        String::new(),
        "This guide compares Claude Code-style Rust development tasks across models routed through a configurable Anthropic-compatible gateway. Each run records command output, deterministic checks, git diff, latency, judge score, and Claude Code statistics such as tokens, cost, API time, TTFT, and turn count.".to_string(),
        String::new(),
